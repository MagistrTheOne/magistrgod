...
const SignupForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-secondary p-8 rounded-lg shadow-lg w-full max-w-md">
      <h2 className="text-2xl font-bold text-center mb-4 text-purple-300">Создать аккаунт</h2>
      ...
      <div className="mb-6">
        <label htmlFor="confirmPassword" className="block text-sm">Подтвердите пароль</label>
        <input
          type="password"
          id="confirmPassword"
